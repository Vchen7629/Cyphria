...
class GPUNameNormalizer:
    ...
    def _format_name(self, brand: str, model: str, brand_prefix: str | None, variant: str | None) -> str | None:
        """
        ...
        if brand == 'NVIDIA':
            ...
            if variant and variant.lower() != 'fe':
                variant_str = f" {variant.upper() if variant.lower() == 'super' else variant.capitalize()}"
