...
def test_lost_connection_during_operation(db_connection: psycopg.Connection, single_product_sentiment: dict[str, Any]) -> None:
    ...
    with pytest.raises(psycopg.OperationalError):
        fetch_unique_products(db_connection, time_window='all_time')
