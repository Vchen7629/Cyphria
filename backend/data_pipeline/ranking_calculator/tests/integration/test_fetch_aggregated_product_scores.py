...
def test_fetch_single_comment_comment(
    ...
    result = fetch_aggregated_product_scores(
        db_connection, product_topic="GPU", time_window="all_time"
    )
...
def test_fetch_empty_database(db_connection: psycopg.Connection) -> None:
    ...
    result = fetch_aggregated_product_scores(
        db_connection, product_topic="Any", time_window="all_time"
    )
...
@pytest.mark.parametrize(
    argnames="product_topic, time_window",
    argvalues=[
...
def test_avg_aggregation_works_for_multiple_same_products(
    db_connection: psycopg.Connection,
) -> None:
    comments = [
        {
...
def test_empty_product_topic_string(db_connection: psycopg.Connection) -> None:
    ...
    result = fetch_aggregated_product_scores(
        db_connection, product_topic="", time_window="all_time"
    )
...
def test_fetch_nonexistant_category(
    db_connection: psycopg.Connection, single_sentiment_comment: dict[str, Any]
) -> None:
    ...
    result = fetch_aggregated_product_scores(
        db_connection, product_topic="dog", time_window="all_time"
    )
