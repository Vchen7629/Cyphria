...
async def test_success(
    ...
    response = await fastapi_client.client.get("/api/v1/product/search?q=nvidia&current_page=1")
...
async def test_prefix_match_ordering(
    ...
    response = await fastapi_client.client.get("/api/v1/product/search?q=rtx&current_page=1")
...
async def test_search_non_existing_product_name(
    ...
    response = await fastapi_client.client.get("/api/v1/product/search?q=auuugh&current_page=1")
...
async def test_correct_page_values(
    ...
    first_page_res = await fastapi_client.client.get("/api/v1/product/search?q=gpu&current_page=1")
    ...
    third_page_res = await fastapi_client.client.get("/api/v1/product/search?q=gpu&current_page=3")
