...
async def test_fetch_products_in_same_topic(
    ...
    products = [
        {**single_product_ranking_row, "product_name": "product_gpu", "product_topic": "GPU"},
        {**single_product_ranking_row, "product_name": "product_cpu", "product_topic": "GPU"},
        {**single_product_ranking_row, "product_name": "product_photography", "product_topic": "tripod"},
    ]
    ...
    response = await fastapi_client.client.get("/api/v1/topic/total_products_ranked?product_topic=GPU")
...
async def test_no_matching_products(
    ...
    response = await fastapi_client.client.get("/api/v1/topic/total_products_ranked?product_topic=NONEXISTANT")
