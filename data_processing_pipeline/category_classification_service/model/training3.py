...
class XgBoostModel:
    ...
    def train(self) -> None:
        ...
        train_x, test_x, train_y, test_y, train_id, test_id = train_test_split(
            self.x, self.xgboost_labels, indicies, test_size=0.3, random_state=42, stratify=self.labels)
    ...
    def evaluate(self) -> None:
        ...
        print(classification_report(self.y_test_labels, self.xgboost_y_pred_labels))
