...
const chartData = [
  { date: "2024-04-01", desktop: 222, mobile: 150, test1: 300 },
    ...
    <Card className="bg-[#141414] border-2 border-bordercolor">
      <CardHeader className="flex items-center gap-2 space-y-0 py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          <CardTitle className="text-2xl font-thin text-gray-400">Sentiments For Trending Topics Over Time</CardTitle>
          <CardDescription>
            Showing Sentiments over the Past 3 months
          </CardDescription>
        </div>
